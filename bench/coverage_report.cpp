...
total_pts = circuit.num_branch_cov_pts();
c=0;
//cout <<"Total number of branches : "<< total_pts << endl;
while ( c < total_pts)
{
if(circuit.get_cov_pt_value(c)>0)
{
b++;           // if covered increment
}
c++;
}
//cout <<"Total number of covered branches : "<< b << " \n" ;
coverage = (b/total_pts)*100; // compute %
cout << "The expected branch coverage is "<< coverage << "%"<< endl;
